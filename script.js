        ...
        function updateTable(item) {
                ...
                exp.innerHTML = item.exp;
                    ...
                    /*If Shelf Life Is Less Than 3 Days, Set Background To Red*/
                       if(parseFloat(item.life) < 1) tablerow.style.backgroundColor = "Black";
                if(parseFloat(item.life) <= 3) tablerow.style.backgroundColor = "red";
                if(parseFloat(item.life) >= 4 && (parseFloat(item.life) < 7)) tablerow.style.backgroundColor ="yellow";
                if(parseFloat(item.life) >= 7) tablerow.style.backgroundColor = "lightBlue";
